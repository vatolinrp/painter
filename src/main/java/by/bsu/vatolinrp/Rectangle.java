...
public class Rectangle extends Poligon
{
    ...
    public void paint(Graphics2D g)
    {
        ...
        g.fillRect(getPointsList()[0].x, getPointsList()[0].y, getPointsList()[1].x - getPointsList()[0].x,
                getPointsList()[1].y - getPointsList()[0].y);
        g.setColor(getLineColor());
        g.drawRect(getPointsList()[0].x, getPointsList()[0].y, getPointsList()[1].x - getPointsList()[0].x,
                getPointsList()[1].y - getPointsList()[0].y);
